...
// ======================= RIÊNG CHO TRANG CHỦ ĐỀ (SỬA LẠI) =======================
function renderCategories() {
  const container = document.getElementById("products-container");

  // Cấu hình danh sách các từ khóa cần lọc
  const targetCategories = [
    { key: ["hoasinhnhat", "hoa sinh nhật"], title: "--- HOA SINH NHẬT ---" },
    { key: ["hoacauhon", "hoa cầu hôn"], title: "--- HOA CẦU HÔN ---" },
    {
      key: ["hoakhaitruong", "hoa khai trương"],
      title: "--- HOA KHAI TRƯƠNG ---",
    },
    {
      key: ["hoatotnghiep", "hoa tốt nghiệp"],
      title: "--- HOA TỐT NGHIỆP ---",
    },
    { key: ["hoachiabuon", "hoa chia buồn"], title: "--- HOA CHIA BUỒN ---" },
  ];

  targetCategories.forEach((group) => {
    // Lọc thông minh: Kiểm tra xem category của sp có nằm trong danh sách từ khóa không
